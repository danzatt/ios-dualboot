Obtaining tools
============
__Note:__ *if you are going to build the tools yourself you will need to have a [Theos](http://www.iphonedevwiki.net/index.php/Theos) set up. If you are on __OS X__ you need to have Xcode installed and follow [the guide on iPhone Dev Wiki](http://www.iphonedevwiki.net/index.php/Theos/Setup#Installing_Theos). If you are on __Windows__ [coolstar has done most all the hard work](https://coolstar.org/iOSToolchainOnWindows.html). And if you are on __Linux__ you can [use Darling to run OS X binaries](http://www.eswick.com/2014/03/11/Building-iOS-ARM64-Binaries-on-Linux/), go for a [native toolchain](https://github.com/waneck/linux-ios-toolchain) or [grab a fully setup Theos with compiled toolchain](https://twitter.com/coolstarorg/status/496362772217597952).*  
